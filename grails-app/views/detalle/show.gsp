...
<html>
    ...
    <body>
        ...
        <div id="show-detalle" class="content scaffold-show" role="main">
            ...
            <f:display bean="detalle" />
            <g:form resource="${this.detalle}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.detalle}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
