...
class SectorControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        given:
        controller.sectorService = Mock(SectorService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.sectorService = Mock(SectorService) {
            1 * save(_ as Sector) >> { Sector sector ->
                throw new ValidationException("Invalid instance", sector.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.sector instanceof Sector
    }
